...
::: notes
-   Now that we covered the needs for iRODS in R. 
-   Let's look at how we develop a package that can be used by all.
:::
...
::: notes
- Let's look of the design choices that we made.
...
-   `>= R 4.1` and `readr`, `dplyr`, and `ggplot2`.
...
- The data that I use is about GitHub stats of iRODS
:::
